    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link {{ ($active === "event") ? 'active' : '' }}" href="/events">Event</a>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ ($active === "dashboard") ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
