...
<table class="table table-striped table-sm">
    ...
    <tr>
        ...
        <td>{{ $category->name }}</td>
        <td>
            <a href="/dashboard/categories/{{ $category->slug }}" class="badge bg-info dark-text"><i class="bi bi-eye"></i></a>
            <a href="/dashboard/categories/{{ $category->slug }}/edit" class="badge bg-warning dark-text"><i class="bi bi-pencil"></i></a>
